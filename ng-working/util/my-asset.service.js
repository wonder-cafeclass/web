...
var MyAssetService = (function () {
    function MyAssetService(us) {
        this.us = us;
        // 서비스 서버내의 리소스 - 이미지, html 파일등 - (을)를 가져오는 유틸 클래스.
        // 개발 서버 혹은 서비스 서버등의 환경에도 일관되게 리소스를 가져오는 역할을 합니다.
    ...
    MyAssetService.prototype.getInner = function (imgUrl) {
        // url segment를 보낸 경우, 자신의 app base href를 확인, full request url을 만들어 준다.
        if (null === this.us) {
            return "";
        }
        return this.us.getInner(imgUrl);
    };
    MyAssetService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [url_service_1.UrlService])
    ], MyAssetService);
    return MyAssetService;
}());
exports.MyAssetService = MyAssetService;
//# sourceMappingURL=my-asset.service.js.map