...
var MyLoggerService = (function () {
    function MyLoggerService(us, http) {
        ...
        this.pageTypeTeacherInfoKlass = "TEACHER_INFO_KLASS";
        this.pageTypeTeacherInfoReview = "TEACHER_INFO_REVIEW";
        this.pageTypeTeacherInfoQuestion = "TEACHER_INFO_QUESTION";
