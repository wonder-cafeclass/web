...
var UserSearchComponent = (function () {
    function UserSearchComponent(cclassSearchService, router) {
    ...
    UserSearchComponent.prototype.gotoDetail = function (cclasses) {
    ...
    UserSearchComponent = __decorate([
        ...
        __metadata('design:paramtypes', [cclass_search_service_1.CClassSearchService, router_1.Router])
    ], UserSearchComponent);
