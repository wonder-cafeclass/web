...
export class TeacherInfoKlassAttendanceComponent implements AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    if(this.isDebug()) console.log("teacher-info-klass-attendance / ngAfterViewInit");
    this.asyncViewPack();
  }

  private asyncViewPack(): void {
    
    if(this.isDebug()) console.log("teacher-info-klass-attendance / asyncViewPack / 시작");

    // 이미 View 기본정보가 들어왔다면 바로 가져온다. 
    if(this.watchTower.getIsViewPackReady()) {
      if(this.isDebug()) console.log("teacher-info-klass-attendance / asyncViewPack / isViewPackReady : ",true);
      this.init();
    } // end if
    ...
    this.watchTower.isViewPackReady$.subscribe(
      ...
      if(this.isDebug()) console.log("teacher-info-klass-attendance / asyncViewPack / subscribe / isViewPackReady : ",isViewPackReady);
      this.init();
    }); // end subscribe
  ...
  private init() :void {
    ...
    if(this.isDebug()) console.log("teacher-info-klass-attendance / init / 시작");
  ...
  private setLoginUser() :void {
    ...
    if(this.isDebug()) console.log("teacher-info-klass-attendance / setLoginUser / 시작");
  ...
  private logActionPage() :void {
    ...
    if(this.isDebug()) console.log("teacher-info-klass-attendance / logActionPage / 시작");
  ...
  private emitEventOnReady() :void {
    ...
    if(this.isDebug()) console.log("teacher-info-klass-attendance / emitEventOnReady / 시작");
  ...
  private fetchTeacherInfoDashboard():void {
    ...
    if(this.isDebug()) console.log("teacher-info-klass-attendance / fetchTeacherInfoDashboard / 시작");
  ...
  onClickKlass(klass:Klass):void {
    ...
    if(this.isDebug()) console.log("teacher-info-klass-attendance / onClickKlass / 시작");

    if(null == klass) {
      if(this.isDebug()) console.log("teacher-info-klass-attendance / onClickKlass / 중단 / null == klass");
      return;
    } // end if

    if(!(0 < klass.id)) {
      if(this.isDebug()) console.log("teacher-info-klass-attendance / onClickKlass / 중단 / klass.id is not valid!");
      return;
    } // end if
  ...
  onChangedFromChild(myEvent:MyEvent) {
    ...
    if(this.isDebug()) console.log("teacher-info-klass-attendance / onChangedFromChild / init");
    if(this.isDebug()) console.log("teacher-info-klass-attendance / onChangedFromChild / myEvent : ",myEvent);
    if(this.isDebug()) console.log("teacher-info-klass-attendance / onChangedFromChild / myEvent.key : ",myEvent.key);
    if(this.isDebug()) console.log("teacher-info-klass-attendance / onChangedFromChild / myEvent.value : ",myEvent.value);

    if(myEvent.isNotValid()) {
      if(this.isDebug()) console.log("teacher-info-klass-attendance / onChangedFromChild / ON_CHANGE_NOT_VALID / 중단 / myEvent.isNotValid()");
      // 에러 로그 등록
      this.watchTower.logErrorBadValue(
        `teacher-info-klass-attendance / onChangedFromChild / myEvent.isNotValid()`
      );
      return;
    } // end if

    if(this.watchTower.isNotOK(myEvent)) {
      if(this.isDebug()) console.log("teacher-info-klass-attendance / onChangedFromChild / 중단 / 값이 유효하지 않습니다.");
      // 에러 로그 등록
      this.watchTower.logErrorBadValue(
        `teacher-info-klass-attendance / onChangedFromChild / this.watchTower.isNotOK(myEvent)`
      );
      return;
    } // end if
