...
var KlassDetailComponent = (function () {
    function KlassDetailComponent(route, router, klassService, imageService, 
        // public dialogService: DialogService,
        authService, myLoggerService, myEventService, watchTower, radiobtnService, checkboxService, teacherService, defaultService, urlService, myCheckerService) {
        this.route = route;
        this.router = router;
    ...
    KlassDetailComponent.prototype.setKlassDateEnrollmentInput = function () {
        ...
        var dateListKey = this.myTime.getDateListYYYYMMDDKDWidthDayList(
        // dayIdx:number,
        ...
        var dateListValue = this.myTime.getDateListYYYYMMDDWidthDayList(
        // dayIdx:number,
        this.klassCopy.days_list, 
        // weekIdxBegin:number,
        0, 
        ...
        for (var i = 0; i < dateListKey.length; ++i) {
            var key = dateListKey[i];
            var value = dateListValue[i];
            var isFocus = (this.klassCopy.date_begin === value) ? true : false;
